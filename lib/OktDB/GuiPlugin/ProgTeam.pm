...
has actionCfg => sub {
    ...
    return [
        ...
        },
        {
            ...
            action => 'submitVerify',
            addToContextMenu => true,
            question => trm('Do you really want to delete the selected Member from the OKT Program Team? This will only work if there are no other entries refering to that Member. Maybe you would rather edit the end date.'),
            key => 'delete',
            buttonSet => {
                enabled => false
            },
